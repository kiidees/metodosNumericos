...
public class Biseccion {
    ...
    public Biseccion(float a, float b, float eP, String fX) {
        this.a = a;
        this.b = b;
    ...
    public void calcular(){
        funcionEvA=eval.evaluar(fX,a); //evalua la funcion con el valor que le otorguemos en a
        funcionEvB=eval.evaluar(fX,b); //evalua la funcion con el valor que le otorguemos en b
        ...
        if(funcionEvA*funcionEvB>0){
            ...
            do{
                equisR=(b+a)/2; //formula para determinar la raiz
                ...
                //imprimimos el numero de iteracion, el valor de la raiz y el error
